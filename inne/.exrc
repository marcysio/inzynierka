...
noremap <silent> <F5> gg49OG49o50%
noremap <silent> <F3> :call ScrollOffToggle():Limelight!!
noremap <silent> <F2> :Goyo
nnoremap <C-T> :VimtexTocOpen
inoremap  u[s1zg``au
...
set ruler
set runtimepath=~/.vim,~/.vim/plugged/fzf,~/.vim/plugged/traces.vim,~/.vim/plugged/vimtex,~/.vim/plugged/ultisnips,~/.vim/plugged/vim-sandwich,~/.vim/plugged/fzf.vim,~/.vim/plugged/limelight.vim,~/.vim/plugged/goyo.vim,~/.vim/plugged/vim-easy-align,~/.vim/plugged/vim-airline,~/.vim/plugged/vim-airline-themes,~/.vim/plugged/FastFold,~/.vim/plugged/vim-fugitive,~/.vim/plugged/vim-easymotion,~/.vim/plugged/gruvbox,~/.vim/plugged/vim-ripgrep,~/.vim/plugged/typescript-vim,~/.vim/plugged/vim-man,~/.vim/plugged/vim-rtags,~/.vim/plugged/ctrlp.vim,~/.vim/plugged/YouCompleteMe,~/.vim/plugged/undotree,/usr/share/vim/vimfiles,/usr/share/vim/vim82,/usr/share/vim/vimfiles/after,~/.vim/plugged/vimtex/after,~/.vim/plugged/ultisnips/after,~/.vim/plugged/vim-sandwich/after,~/.vim/after,/usr/local/lib/python2.7/dist-packages/powerline/bindings/vim/
set scrolloff=5
set shiftwidth=2
set showcmd
set smartcase
